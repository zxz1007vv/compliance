from wbc_compliance_gym.assets.asset import Asset
...
class Door(Asset):
    ...
    def initialize(self):
        door_asset_path = '{WBC_COMPLIANCE_ROOT_DIR}/resources/objects/door/lever_baxter_leftarm.urdf'.format(WBC_COMPLIANCE_ROOT_DIR=WBC_COMPLIANCE_ROOT_DIR)
