...
class LeggedRobot(CommandLifecycleMixin, BaseTask):
    ...
    def initialize_sensors(self):
        """ Initializes sensors
        """
        from wbc_compliance_gym.sensors import make_sensor
    ...
    def create_sim(self):
        ...
        from wbc_compliance_gym.terrains import ALL_TERRAINS
    ...
    def _init_buffers(self):
        ...
        if self.cfg.env.force_control_init_poses:
            try:
                data = np.load(WBC_COMPLIANCE_ROOT_DIR + '/wbc_compliance_gym/envs/base/wbc_data_isaac.npz')
    ...
    def _prepare_reward_function(self):
        ...
        """
        # reward containers
        from wbc_compliance_gym.rewards import make_reward_container
    ...
    def _create_envs(self):
        ...
        from wbc_compliance_gym.assets.ball import Ball
        from wbc_compliance_gym.assets.cube import Cube
        from wbc_compliance_gym.assets.door import Door
        from wbc_compliance_gym.assets.chair import Chair
        from wbc_compliance_gym.assets.bucket_of_balls import BallBucket
        ...
        if self.cfg.perception.measure_heights:
            from wbc_compliance_gym.sensors import HeightmapSensor
        ...
        from wbc_compliance_gym.utils.logger import Logger
    ...
    def initialize_cameras(self, env_ids):
        ...
        from wbc_compliance_gym.sensors import AttachedCameraSensor
