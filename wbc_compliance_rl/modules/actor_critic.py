...
from .adaptation_module import build_adaptation_module
...
class ActorCritic(nn.Module):
    ...
    def __init__(self, num_obs,
        ...
        self.cfg = cfg if cfg is not None else AC_Args
        self.decoder = self.cfg.use_decoder
        super().__init__()

        self.adaptation_labels = self.cfg.adaptation_labels
        self.adaptation_dims = self.cfg.adaptation_dims
        self.adaptation_weights = self.cfg.adaptation_weights
        ...
        # Adaptation module. Keep nn.Sequential keys for checkpoint compatibility.
        self.adaptation_module = build_adaptation_module(
            self.num_obs_history,
            self.num_privileged_obs,
            self.cfg.adaptation_module_branch_hidden_dims,
            activation,
        )
